...
class ConsultaChecklistDoCoordenador
{
    ...
    public function executa($request)
    {
        ...
        $items = $repositorio->selectPadrao(
            "tipo = 'C' and id_usuario_criou = ?",
            "tb_questionario.id_questionario, titulo, tb_questionario.descricao, data_inicio, data_fim, padrao, status, id_url",
            null,
